...
To obtain Figure 3, run plot_scenario.R (for Figure 3 in the manuscript and other scenarios in the Supplementary Material)

To obtain Figure 4, run plot_outlier_setting.R (for Figure 4 in the manuscript and other outlier scenarios in the Supplementary Material)


To obtain Figure 5, run plot_sparseness_setting.R (for Figure 5 in the manuscript and sparseness settings under different scenarios in the Supplementary Material)
